Algoritmo hito1
	...
	Segun resultado5 Hacer
		0:
			Escribir "Tu nota es 0"
		1:
			Escribir "Tu nota es 1"
		2:
			Escribir "Tu nota es 2"
		3:
			Escribir "Tu nota es 3"
		4:
			Escribir "Tu nota es 4"
		5:
			Escribir "Tu nota es 5"
		6:
			Escribir "Tu nota es 6"
		7:
			Escribir "Tu nota es 7"
		8:
			Escribir "Tu nota es 8"
		9:
			Escribir "Tu nota es 9"
		10:
			Escribir "Tu nota es 10"
	FinSegun
